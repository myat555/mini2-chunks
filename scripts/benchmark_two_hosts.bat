...
python benchmark_unified.py --config "!ACTIVE_CONFIG!" --leader-host 192.168.1.2 --leader-port 60051 --num-requests !NUM_REQUESTS! --concurrency !CONCURRENCY! --log-dir logs\two_hosts --output-dir logs\two_hosts
