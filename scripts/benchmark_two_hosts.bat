...
python benchmark_unified.py --config "!ACTIVE_CONFIG!" --leader-host 192.168.1.2 --leader-port 60051 --num-requests 400 --concurrency 20 --log-dir logs\two_hosts --output-dir logs\two_hosts
