#!/bin/bash
# Benchmark script for two-host setup (macOS/Linux)
# Usage: ./run_benchmark_two_hosts.sh [--num-requests N] [--concurrency N]

DEFAULT_REQUESTS=400
DEFAULT_CONCURRENCY=20
CONFIG_FILE="configs/two_hosts_config.json"
LEADER_HOST="192.168.1.2"
LEADER_PORT=60051
LOG_DIR="logs/two_hosts"
